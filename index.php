<?php
	session_start ();
	session_register ($txUsuario, $txPass);
...
</script><marquee><font color="red"><a class="sbutec">Sistema Bibliotecario</a><a class="sbest"> Estandares de Programacion 01-2012</a></font></marquee>
	</head>
<!--LOGIN ADMINISTRADOR -->
<div id="bar">
        <div id="container">
       ...
       <h3>Bienvenidos</h3>
        <ul>
            <li><span><a href="javascript:void(0);" id="link-posts">Mision</a></span>
                <ul>
                    <li><a class="bullet">La Universidad Tecnol&oacute;gica de El Salvador existe para brindar en amplios 
					sectores poblacionales, innovadores servicios educativos, promoviendo su capacidad cr&iacute;tica y su 
					responsabilidad social; utilizando metodolog&iacute;as y recursos acad&eacute;micos apropiados; desarrollando 
					institucionalmente: Investigaci&oacute;n pertinente y proyecci&oacute;n social, todo consecuente con su filosof&iacute;a 
					y su legado cultural.</a></li>
                </ul>
            </li>
            <li><span><a href="javascript:void(0);" id="link-categorias">Vision</a></span>
                <ul>
                    <li><a class="bullet">Ser reconocida como una de las mejores universidades privadas de la regi&oacute;n, a trav&eacute;s 
					de sus egresados y de sus esmerados procesos institucionales de construcci&oacute;n y aplicaci&oacute;n del conocimiento,
					proponiendo soluciones pertinentes a las necesidades de amplios sectores de la sociedad.</a></li>
                </ul>
            </li>
			<li><span><a href="javascript:void(0);" id="link-usuarios">Integrantes</a></span>
                <ul>
                    <li><a class="list">Karla Vanessa Molina Salazar</a></li>
					<li><a class="list">Jaqueline Susana Sanchez Mena</a></li>
					<li><a class="list">Yancy Beatriz Garay Velasquez</a></li>
					<li><a class="list">Walter Humberto Ramos Vega</a></li>
					<li><a class="list">Ronald Alexander Requeno Munguia</a></li>
                </ul>
            </li>
...
<!-- FIN DE MISION Y VISION-->	
	...
	<fieldset id="fsLogin" class="clear" style="width:320px;" align="center">
		...
		<tr>
			<td colspan="2" align="center"><input type="checkbox" name="ckBibliotecario" value="bibliotecario" title="Checkar si eres Bibliotecario"class="check"><label class="bib">Soy Bibliotecario</label></td>
		</tr>
		<tr>
