...
.enlaceboton:hover {
	...
	<center><font size="4"><b>Devoluci&oacute;n de Libros </b></font></center>
	<form action="resultadoDevolucionLibro.php" method="get" name="devolucion" target="devolucionFrame">
		<table align="center" border="0">
		<tr><td align="center"><hr color="#c1f"/><b>N° de Carnet:</b></td></tr>
		<tr><td align="center"><input type="text" placeholder="Ej: '2523782007'" onkeypress='return val(event)' class="caja" name="txDev"></td></tr>
