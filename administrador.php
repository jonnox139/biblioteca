...
<div class="config">
	...
	<b>Buscar Mora:<br></b><input type="text" maxlength="10" class="caja2" placeholder='# Carnet' onkeypress='return val(event)' name="txCarnetMora">
...
<div class="opciones">
	...
	<center><h2>Menu Principal</h2></center>
		<ul id="navlist">
		<li><a class="enlaces" href="agregarLibros2.php"><center>Agregar Libros</center></a>	<li>
		<li><a class="enlaces" href="autorizarPrestamos2.php"><center>Autorizar Prestamos</center></a><li>
		<li><a class="enlaces" href="devolucionlibros2.php"><center>Devoluci&oacute;n de Libros</center></a><li>
		<li><a class="enlaces" href="consultarDisponibilidad2.php"><center>Consultar Disponibilidad</center></a><li>
		</ul>
	</div>
</div>
...
<center>
<div class="bibl">
<table border="0"><tr><td colspan="2"><h2>Gesti&oacute;n Bibliotecaria</h2></td></tr>
	<tr><td><form action="eliminarLibros.php?<?php echo (session_name()); ?>=<?php echo (session_id()); ?>"><input type="submit" value="" class="elimLibro" title="Eliminar Libro"></form></td>
	<td align="center"><a name="reg" tabindex="1" href="registroUsuarioAdministrador.php" class="registro">Registrar Usuarios</a><br><br><form action="insertarCategoria.php" method="get"><b>Agregar Categoria <br>del Libro:<br></b><input type="text"  class="caja" name="txCat" onKeyPress="return val2(event)"><br><a class="ej">Ej: "Psicolog&iacute;a, Inform&aacute;tica"</a><br><input type="submit" class="btn" value="Agregar"></form></td></tr>
</table>
</div>
</center>
...
<!-- MENU PESTAÑAS -->
	<div class="aux">
			...
			<center><h2>Administraci&oacute;n de Recursos Humanos</h2></center>
                <ul class="menu">
                    <li id="noticias" class="active">Bibliotecarios</li>
                    <li id="tutoriales">Alumnos</li>
                ...
                <div class="content noticias">
                    ...
                    <?php 
					$bibl="SELECT * FROM bibliotecario ORDER BY id_empleado ASC"; 
					$bibl2=mysql_query($bibl, $conexion);
					while($b = mysql_fetch_array($bibl2, MYSQL_ASSOC))
					{
						echo("<tr><td><font color='white'>".$b["id_empleado"]."</font></td>");
						...
						?><td align="center"><input type='checkbox' onClick="javascript:ir('eliminarBi.php');" name="ckBi" value="<?php echo($b["nombreEmpleado"]); ?>" ></td></tr>
						<?php
					}
					?>
					</table>
                ...
                <div class="content tutoriales">
					...
					<table class="tabla" border="1" width="600">
					<tr>
					<td><font color='red'><b>Carnet</b></font></td>
					<td><font color='red'><b>Nombre del Alumno</b></font></td>
					<td><font color='red'><b>Telefono</b></font></td>
					<td><font color='red'><b>Email</b></font></td>
					<td><font color='red'><b>Direccion</b></font></td>
					<td><font color='red'><b>Eliminar</b></font></td></tr>
                    <?php 
					$bibli="SELECT * FROM alumnos ORDER BY nombreAlumno ASC"; 
					$bibli2=mysql_query($bibli, $conexion);
					while($bi = mysql_fetch_array($bibli2, MYSQL_ASSOC))
					{
						$cc1=substr($bi["carnet"], 0,2);
						$cc2=substr($bi["carnet"], 2,4);
						$cc3=substr($bi["carnet"], 6,8);
						echo("<tr><td><font color='white'>".$cc1."-".$cc2."-".$cc3."</font></td>");
						echo("<td><font color='white'>".$bi["nombreAlumno"]."</font></td>");
						echo("<td><font color='white'>".$bi["telefonoAlumno"]."</font></td>");
						echo("<td><font color='white'>".$bi["emailAlumno"]."</font></td>");
						echo("<td><font color='white'>".$bi["direccionAlumno"]."</font></td>");
						?><td align="center"><input type='checkbox' onClick="javascript:ir('eliminarA.php');" name="ckA" value="<?php echo($bi["nombreAlumno"]); ?>" ></td></tr>
						<?php
					}
					?>
					</table>
                ...
                <div class="content enlaces">
				 ...
				 <div class="content reportes">
                   <center> 
				   <a href="prestamos.php?<?php echo(session_name());?>=<?php echo(session_id());?>" class="aOpciones">Historial de Prestamos</a><br>
