...
if($dia!="1" && $mes!="Enero" && $annio!="")
	{
		$buscarHistorial="SELECT DISTINCT nombreAlumno, fechaPrestamoLibro FROM comprobante WHERE fechaPL='".$_SESSION["annio"]."-".$_SESSION["mes"]."-".$_SESSION["dia"]."';";
		...
		<center><a class="titulo">UNIVERSIDAD TECNOLOGICA DE EL SALVADOR</a><br>
		<?php 
	...
	?>
	Prestamos correspondientes al dia: <b><?php echo($_SESSION["dia"]." de ".$_SESSION["mes"]." del ".$_SESSION["annio"]); ?>
